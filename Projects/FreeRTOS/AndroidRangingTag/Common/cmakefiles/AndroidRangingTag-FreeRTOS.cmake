...
set(USE_NIQ 1)
set(USE_ANDROID_OOB 1)

set(USE_BOARD_LIB ON)
set(CONFIG_QM33 1)

# Disable RTT logs to reduce power consumption
set(CONFIG_LOG OFF)
...
add_definitions(-DANDROID_RANGING_TAG_BUILD)
...
if(USE_FIRA)
  ...
  target_link_libraries(fira PUBLIC reporter Config)
  list(APPEND LINK_LIB_LIST "fira")
endif()

add_subdirectory(${PROJECT_COMMON}/src/fira fira_android_ranging_tag)
list(APPEND LINK_LIB_LIST "fira_android_ranging_tag")
